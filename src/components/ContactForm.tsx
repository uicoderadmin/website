...
export function ContactForm() {
  ...
  return (
    <form
      ...
      className="w-full lap:w-3/4 desk:w-7/12 p-6 desk:p-20 lap:mx-auto text-absolute-white lap:border-x lap:border-grey-15 gap-7 desk:gap-10 flex flex-col"
    >
      ...
      <div className="flex justify-center">
        <button
          type="submit"
          className="bg-green-50 text-absolute-black desk:text-lg px-11 py-3 lap:py-4 w-full lap:w-fit text-sm rounded-md hover:bg-green-60"
        >
          Submit
        </button>
      </div>
